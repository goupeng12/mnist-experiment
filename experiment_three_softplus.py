...
x2 = tf.nn.softplus(W1x1b1) #激活函数			  60000x10的矩阵
...
x3 = tf.nn.softplus(W2x2b2) #激活函数				  60000x784的矩阵
...
train_writer = tf.summary.FileWriter('exp_three_softplus_train_logs',sess.graph) #将训练日志写入到logs文件夹下
